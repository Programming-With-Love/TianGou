...
// arModel is a active record design model for table diary operations.
type arModel struct {
	gmvc.M
}

var (
	// Table is the table name of diary.
	Table = "diary"
	// Model is the model object of diary.
	Model = &arModel{g.DB("default").Table(Table).Safe()}
	// Columns defines and stores column names for table diary.
	Columns = struct {
		Time     string //   
        Content  string //   
        Id       string //
